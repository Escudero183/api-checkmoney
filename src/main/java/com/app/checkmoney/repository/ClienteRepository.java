...
public interface ClienteRepository extends JpaRepository<Cliente, Integer>{
	...
	@Query("select c from Cliente c Where c.estado = true and (lower(c.razonSocial) like :query or lower(c.representanteLegal) like :query or lower(c.documento) like :query or lower(c.codigoOsinergmin) like :query)")
